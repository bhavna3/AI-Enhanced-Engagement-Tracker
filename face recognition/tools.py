    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            for face_location in face_locations:
                ...
                cv.putText(frame, 'Bhavana', (left, top - 10), cv.FONT_HERSHEY_SIMPLEX, 0.5,
            ...
            new_entry = pd.DataFrame({'Name': ['Bhavana'], 'Date': [date_str], 'Time': [time_str]})
...
if not df.empty:
    df.to_excel('attendancetool.xlsx', index=False)
