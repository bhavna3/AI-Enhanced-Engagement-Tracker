...
known_image = face_recognition.load_image_file(r"C:\Users\saikeerthana\OneDrive\Desktop\AI engagement tracker\face_recognition\obama_img.jpeg")
...
cam = cv.VideoCapture(r'C:\Users\saikeerthana\OneDrive\Desktop\AI engagement tracker\face_recognition\obama_vid.mp4')
if not cam.isOpened():
